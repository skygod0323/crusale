...
//				$pathS="../upload/logo/small/".$rowImg->ht_logo;	
				...
				$imgSImage->save("../upload/advertisement/".$this->adv_img,$_FILES['adv_img']['type']);											
...
<div class="main-content">
	<div class="breadcrumbs" id="breadcrumbs">
		...
		<ul class="breadcrumb">
			...
			<li>
				<a href="advertisement-view.php">Advertisement Management</a>
			</li>
...
<form class="form-horizontal" action="" id="test_edit" name="test_edit" method="post" enctype="multipart/form-data">
	...
	<div class="form-group">
		...
		<div class="col-sm-9">
			<select name="" id="" disabled="disabled">
                ...
                <option value="999x100" <?php if($row->adv_imagewidth=="999" && $row->adv_imageheight=="100"){ ?> selected="selected"<?php } ?>>999 x 100</option>
               	<option value="728x090" <?php if($row->adv_imagewidth=="728" && $row->adv_imageheight=="090"){ ?> selected="selected"<?php } ?>>728 x 90</option>
                <option value="300x250" <?php if($row->adv_imagewidth=="300" && $row->adv_imageheight=="250"){ ?> selected="selected"<?php } ?>>300 x 250</option>
            </select>
            <input type="hidden" id="adv_imagewidth" name="adv_imagewidth" value="<?php echo $row->adv_imagewidth; ?>" />
            <input type="hidden" id="adv_imageheight" name="adv_imageheight" value="<?php echo $row->adv_imageheight; ?>" />
		</div>
	</div>
		
	<div class="form-group">
		<label class="col-sm-3 control-label no-padding-right" for="form-field-2">Associted Link</label>
		<div class="col-sm-9">
    ...
    <div class="form-group">
		...
		<div class="col-sm-5">
			<img src="../upload/advertisement/<?php echo $row->adv_img; ?>" style="width:400px;" />
		</div>
	</div>
    <div class="form-group">
		<label class="col-sm-3 control-label no-padding-right" for="form-field-2">Upload Image</label>
		<div class="col-sm-5">
			<div class="ace-file-input"><input name="adv_img" id="id-input-file-2" type="file"></div>
		</div>
	</div>

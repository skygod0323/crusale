...
include "../common.php";
  ...
  check_user_login();
	...
	function detailsObj(){
		$sql="select * from faq_categories where id=".$this->cat_id;
		$res=mysql_query($sql);
	...
	{			
	    ...
	    $this->msg='<div class="alert alert-success"><i class="icon-ok"></i> FAQ Category updated successfully.</div>';
	}	
}
...
if(isset($_POST['btnUpdate'])){
	$ob->category=addslashes(trim($_POST['category']));
	...
	//echo $ecms->msg;
	$_SESSION['msg']=$ob->msg;
	header("location:faq_category_edit.php?cid=".$ob->cat_id);
}
...
<form class="form-horizontal" action="" id="test_add" name="test_add" method="post" enctype="multipart/form-data" onsubmit="return myvalid();">
	...
	<div class="form-group">
		...
		<div class="col-sm-9">
			<input name="category" id="category" class="col-xs-10 col-sm-5" type="text" value="<?php echo $row->category; ?>" />
		</div>
	</div>

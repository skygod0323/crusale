...
if(isset($_POST['acptWebMs']))  //Code for accepting Web master
{
    ...
    $sql_upd_acp="update project_dispute
       set
           pds_closeDate=now(),
           pds_setteledAmount='".$row_pds->pds_releaseAmount."',
           pds_status='0'
       where
           pds_id='".$pds_id."'";
	...
	set
		tr_amount = '".$row_pds->pds_releaseAmount."',
		tr_release = '1'
	where
	...
	set
		es_amount = '".$row_pds->pds_releaseAmount."',
		es_status = '0'
	where 
...
if(isset($_POST['acptFreeln']))  //Code for accepting Freelancer
{
    ...
    $sql_upd_acp="update project_dispute
       set
           pds_closeDate=now(),
           pds_setteledAmount='".$row_pds->pds_claimAmount."',
           pds_status='0'
       where
           pds_id='".$pds_id."'";
    mysql_query($sql_upd_acp);
    ...
    $sql_rel="update transaction
	set
		tr_amount = '".$row_pds->pds_claimAmount."',
		tr_release = '1'
	where
		tr_id = '".$row_to_us->es_tr_id."'";
    ...
    $sql_esc="update escrow 
	set
		es_amount = '".$row_pds->pds_claimAmount."',
		es_status = '0'
	where 
		es_id='".$row_to_us->es_id."'";
    mysql_query($sql_esc);
	...
	<div class="breadcrumbs" id="breadcrumbs">
		...
		<ul class="breadcrumb">
			<li>
				...
				<li class="active">Dispute Details</li>
		</ul><!-- .breadcrumb -->
					<!-- #nav-search -->
	</div>
					...
					<div class="widget-main">
                        ...
                        <div class="clearfix form-actions">
							<div class="col-md-offset-3 col-md-9">
								<button class="btn btn-info" type="submit" name="acptWebMs" id="acptWebMs"><i class="icon-ok bigger-110"></i>Approve</button>
							</div>
						</div>
					</div>
					</div>
	...
	<div class="widget-box">
		...
		<div class="widget-body">
			<div class="widget-main">
                ...
                <div class="clearfix form-actions">
					<div class="col-md-offset-3 col-md-9">
						<button class="btn btn-info" type="submit" name="acptFreeln" id="acptFreeln"><i class="icon-ok bigger-110"></i>Approve</button>
					</div>
				</div>
			</div>
		</div>

...
class addCategory{
	...
	function valid()
	{
		...
		$chksql="select * from category where cat_name like '".$this->cat_name."' and cat_status=1";
		...
		{
			$this->msg= '<div class="alert alert-danger"><i class="icon-remove"></i> Category name already exist.</div>';
			$valid=false;
		}
...
if(isset($_SESSION['cat_name'])){	$cat_name=$_SESSION['cat_name'];	unset($_SESSION['cat_name']);	}else { $cat_name=""; }

if(isset($_POST['btnAdd'])){ 
		
	$adn=new addCategory(addslashes(trim($_POST['cat_name'])));
	
	$_SESSION['cat_name']=addslashes(trim($_POST['cat_name']));
...
<form class="form-horizontal" action="" id="test_add" name="test_add" method="post" enctype="multipart/form-data" onsubmit="return myvalid();">
	...
	<div class="form-group">
		...
		<div class="col-sm-9">
			<input name="cat_name" id="cat_name" class="col-xs-10 col-sm-5" type="text" value="<?php echo $cat_name; ?>" />
		</div>
	</div>

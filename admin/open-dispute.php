...
$al->setsql("select * from project_dispute,project where pds_prj_id=prj_id and pds_status='1'");
	...
	<div class="breadcrumbs" id="breadcrumbs">
		...
		<ul class="breadcrumb">
			<li>
				...
				<li class="active">View Open Disputes</li>
		</ul><!-- .breadcrumb -->
					<!-- #nav-search -->
	</div>
...
<?php $j=0;
	...
	if($count >0)
	{
		...
		<tr>
            ...
            <td style="text-align:center"><a href="dispute-details.php?fid=<?php  echo $row->pds_id ?>" title="Details"><img src="images/details.png"/></a></td>
		</tr>
        <?php $j++; } }?>
</tbody>
</table>

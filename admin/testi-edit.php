...
include 'lib/simpleimage.php';	
	...
	if($this->testi_image != '')
	{
        ...
        if(in_array($ext,$validEXT)) {
			...
			$lstImg = mysql_fetch_object(mysql_query("select testi_image from testimonials where md5(testi_id) = '".$this->testi_id."'"));
...
<em style="display:block;margin:5px;">Fields with <span style="color:#F00">*</span> are required.</em>
	...
	<div class="form-group">
		...
		<div class="col-sm-9">
			<img src="../testimonial_img/<?php echo $row->testi_image; ?>" />
		</div>
	</div>
    <div class="form-group">

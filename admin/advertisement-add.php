...
class addAdvertisement{
	...
	function __construct($imgsize, $adv_link, $adv_img)
	{		
	...
	function valid()
	{
		...
		if($this->imgsize == "0" || $this->imgsize == "")
		{
	...
	{	
		...
		if($_FILES["adv_img"]["name"] != "")
		{
			...
			{
				$this->msg = "Return Code: " . $_FILES["adv_img"]["error"] . "<br />";
...
{ 	
	...
	$adn=new addAdvertisement(addslashes(trim($_POST['imgsize'])), addslashes(trim($_POST['adv_link'])), trim($_FILES['adv_img']['name']));
	if($adn->valid())
	{	
		$adn->add();		
	}
	...
	header("location:advertisement-add.php");
}
...
<div class="page-content">
	...
	<div class="row">
		<div class="col-xs-12">
<form class="form-horizontal" action="" id="adv_add" name="adv_add" method="post" enctype="multipart/form-data">
	...
	<div class="form-group">
		...
		<div class="col-sm-9">
			<select name="imgsize" id="imgsize">
                ...
                <option value="999x100" <?php if($imgsize=="999x100"){ ?> selected="selected"<?php } ?>>999 x 100</option>
               	<option value="728x090" <?php if($imgsize=="728x090"){ ?> selected="selected"<?php } ?>>728 x 90</option>
                <option value="300x250" <?php if($imgsize=="300x250"){ ?> selected="selected"<?php } ?>>300 x 250</option>
            </select>
		</div>
	</div>

...
$al->setsql("select * from contact_us where cu_status = '1' order by cu_id");
...
<?php $j=0;
	...
	if($count >0)
	{
		...
		<tr>
			...
			<td style="text-align:center"><a href="contact-details.php?fid=<?php echo $row->cu_id ?>" title="Details"><img src="images/details.png"></a></td>

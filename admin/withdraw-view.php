...
$al->setsql("select * from withdraw_funds,user where usr_id=wf_usr_id order by wf_updated_date desc");
...
<tr>
	...
	<th style="text-align:center"><strong>Withdraw Fund</strong></th>
...
<tbody>
    	...
    	<tr>
				...
				<td><?php  ?></td>
				<td style="text-align:right"><?php echo number_format($row->usr_balance + $row->wf_amount,2); ?></td>
				<td style="text-align:right"><?php echo number_format($row->wf_amount,2); ?></td>
				<td style="text-align:center"><?php if($row->wf_status == '1') { echo "Released"; } else { echo "<font color='#CC0000'><strong>Requested</strong></font>"; } ?></td>
		</tr>
        <?php $j++; } }?>
</tbody>
</table>

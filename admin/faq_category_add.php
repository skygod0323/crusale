...
include "../common.php";
  ...
  check_user_login();
	...
	{				   	 								
	    ...
	    $this->msg='<div class="alert alert-success"><i class="icon-ok"></i> FAQ Category added successfully.</div>';
	...
	if(isset($_SESSION['category'])){ $category=$_SESSION['category']; unset($_SESSION['category']); } else { $category=""; }
	
	if(isset($_POST['btnAdd'])){ 
	$adn=new addcategory(addslashes(trim($_POST['category'])));		
	$_SESSION['category']=addslashes(trim($_POST['category']));
...
<form class="form-horizontal" action="" id="test_add" name="test_add" method="post" enctype="multipart/form-data" onsubmit="return myvalid();">
	...
	<div class="form-group">
		...
		<div class="col-sm-9">
			<input name="category" id="category" class="col-xs-10 col-sm-5" type="text" value="<?php echo $category; ?>" />
		</div>
	</div>

...
if(isset($_POST['btnUpdate'])){
	...
	$ob->mp_freelancerfee=addslashes(trim($_POST['mp_freelancerfee']));	
	$ob->mp_employerfee=addslashes(trim($_POST['mp_employerfee']));
	$ob->mp_bidspermonth=addslashes(trim($_POST['mp_bidspermonth']));
	$ob->mp_skills=addslashes(trim($_POST['mp_skills']));
	$ob->mp_portfoliosize=addslashes(trim($_POST['mp_portfoliosize']));
...
<div class="main-content">
	<div class="breadcrumbs" id="breadcrumbs">
		...
		<ul class="breadcrumb">
			...
			<li>
				<a href="memplan-view.php">Membership Plan Management</a>
			</li>
...
<div class="page-content">
	...
	<div class="row">
		<div class="col-xs-12">
<form class="form-horizontal" action="" id="test_edit" name="test_edit" method="post" enctype="multipart/form-data" onsubmit="return myvalid();">
	...
	<div class="form-group">
		...
		<div class="col-sm-9">
			<input name="mp_name" id="mp_name" class="col-xs-10 col-sm-5" type="text" value="<?php echo stripslashes($row->mp_name); ?>" />
		</div>
	</div>
   	<div class="form-group">
		<label class="col-sm-3 control-label no-padding-right" for="form-field-2">Rate per month <span style="color:#CC0000">*</span></label>
		<div class="col-sm-9">
			<input name="mp_rate" id="mp_rate" class="col-xs-10 col-sm-5" type="text" value="<?php echo stripslashes($row->mp_rate); ?>" <?php if($row->mp_id=='1'){ ?>readonly="readonly"<?php } ?>/>
		</div>
	</div>
	...
	<div class="form-group">
		...
		<div class="col-sm-9">
			<input name="mp_freelancerfee" id="mp_freelancerfee" class="col-xs-10 col-sm-5" type="text" value="<?php echo stripslashes($row->mp_freelancerfee); ?>" />
		</div>
	</div>
   	...
   	<div class="form-group">
		...
		<div class="col-sm-9">
			<input name="mp_employerfee" id="mp_employerfee" class="col-xs-10 col-sm-5" type="text" value="<?php echo stripslashes($row->mp_employerfee); ?>" />
		</div>
	</div>
   	...
   	<div class="form-group">
		...
		<div class="col-sm-9">
			<input name="mp_bidspermonth" id="mp_bidspermonth" class="col-xs-10 col-sm-5" type="text" value="<?php echo stripslashes($row->mp_bidspermonth); ?>" />
		</div>
	</div>
   	...
   	<div class="form-group">
		...
		<div class="col-sm-9">
			<input name="mp_skills" id="mp_skills" class="col-xs-10 col-sm-5" type="text" value="<?php echo stripslashes($row->mp_skills); ?>" />
		</div>
	</div>
   	...
   	<div class="form-group">
		...
		<div class="col-sm-9">
			<input name="mp_portfoliosize" id="mp_portfoliosize" class="col-xs-10 col-sm-5" type="text" value="<?php echo stripslashes($row->mp_portfoliosize); ?>" />
		</div>
	</div>

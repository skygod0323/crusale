...
$gateway = $_POST['df_method'];
$amount=$_POST['df_amount'];


$al1=mysql_query("select * from payment_gateway where id='".$gateway."'");
...
$fee_amm = $amount * $row_al1['pg_deposit_fee']/100;
}
                            ...
                            <div class="post-padding">
                                    ...
                                    <div class="row">
                                        <div class="col-md-12 col-sm-12">   
											...
											<div><h3 class="header-txt1-style align-center-txt"><?php echo $lang[221]; ?></h3></div>
											<form class="form-horizontal">
												...
												<div style="width:785px;float:left;margin:0 0 0 100px;">
													...
													<div class="signup-form-str" id="msg"><?php echo $msg; ?></div>
														...
														<label class="form-label"><?php echo $lang[222]; ?></label>
																	
																	
														<div style="signup-input-field">
															<?php echo $lang[223]; ?>&nbsp;<?php echo getCurrencySymbol() ?><?php echo $_POST['df_amount']; ?>&nbsp;<?php echo getCurrencyCode() ?>
														</div>
														<div style="signup-input-field">
															<?php echo $lang[224]; ?>&nbsp;<?php echo getCurrencySymbol() ?><?php echo $fee_amm; ?>&nbsp;<?php echo getCurrencyCode() ?>
														</div>
														<div style="signup-input-field">
															<?php echo $lang[225]; ?>&nbsp;<?php echo getCurrencySymbol() ?><?php echo $tot_amount; ?>&nbsp;<?php echo getCurrencyCode() ?>
														</div>

...
$sql_to_us="select * from user,escrow where usr_id=es_to_id and es_prj_id='".$row_pds->pds_prj_id."' and es_status='1' and es_to_id='".$_SESSION['uid']."'";
...
?>
    ...
    <div><h2><?php echo $lang[654]; ?></h2></div>
    
		
    <!--<a class="ns_blue ns_btn" href="project.php?p=<?php /*echo $prj_id;*/ ?>">
            <span></span>
        </a>-->
<!-- basic scripts -->

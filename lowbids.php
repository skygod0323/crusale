...
if($_SESSION['uid']==''){
	$al->setsql("select * from project,project_budget,user where prj_id=pb_prj_id and prj_usr_id=usr_id and now()<prj_expiry and prj_id not in(select bd_prj_id from bid where bd_status=1) and prj_status='open' and prj_id not in(select ppo_prj_id from project_promotion_option where ppo_status='1' and ppo_pp_id=(select pp_id from project_promotion where pp_name='private' and pp_status='1'))");
}
else
{
	$al->setsql("select * from project,project_budget,user where prj_id=pb_prj_id and prj_usr_id=usr_id and now()<prj_expiry and prj_id not in(select bd_prj_id from bid where bd_status=1) and prj_status='open'");
}
                    ...
                    <div class="row">
                        <div class="sidebar col-md-3">
                            <div class="post-padding clearfix">
                                <ul class="nav nav-pills nav-stacked">
									...
									<li class="active"><a href="lowbids.php"><span class="glyphicon glyphicon-off"></span>  <?php echo $lang[118]; ?></a></li>
                        ...
                        <div class="content col-md-9">
                            <div class="post-padding">
                                <div class="job-title nocover hidden-sm hidden-xs"><h5><?php echo $lang[118]; ?></h5></div>
                                        ...
                                        <div class="col-md-12 col-sm-12">   
                                            ...
                                            <div class="table-responsive">
												<table width="100%" class="table table-striped table-bordered table-hover">
													<thead>
														<tr>
															<td colspan="7" align="left" valign="top"><h1><?php echo $lang[172]; ?></h1></td>
														</tr>
														<tr>

...
if(isset($_GET['bd']) && isset($_GET['amt']))
{
    ...
    $_SESSION['last_page']="bidUplift.php?bd="+$bd_id+"&amt="+$amount;
	...
	{
        $_SESSION['promotion_msg']=$lang[700];
		header("location:payment-deposit.php");
	}
	else
	{
		$sql_upd="update bid set bd_uplift='1' where bd_id='".$bd_id."'";
            mysql_query($sql_upd);
		...
		<div style="width:650px;height:100px; padding-bottom:0;">'.$lang[698].'</div></div>';

...
<div><h2 class="header-txt1-style align-center-txt"><?php echo get_page_title(5);  ?></h2></div>
<div align="justify"><?php  echo get_page_content(5);   ?></div>
...
<div class="pg-bottom-text" align="justify">

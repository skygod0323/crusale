...
if($_SESSION['uid']==''){
	$al->setsql("select * from project, project_budget, user where prj_id=pb_prj_id and prj_usr_id=usr_id and prj_status = 'open' and DATEDIFF(prj_expiry,'".date("Y-m-d")."')>=0 and DATEDIFF(prj_expiry,'".date("Y-m-d")."')<=10 and prj_id not in(select ppo_prj_id from project_promotion_option where ppo_status='1' and ppo_pp_id=(select pp_id from project_promotion where pp_name='private' and pp_status='1')) order by prj_expiry");	
}
else
{
	$al->setsql("select * from project, project_budget, user where prj_id=pb_prj_id and prj_usr_id=usr_id and prj_status = 'open' and DATEDIFF(prj_expiry,'".date("Y-m-d")."')>=0  and DATEDIFF(prj_expiry,'".date("Y-m-d")."')<=10 order by prj_expiry");
}
$totalitems=$al->totalrecord();
$limit=$al->limit;
$al->start=$p->setstart($page,$limit,$totalitems);
$adjacents=1;
$targetpage = "ending-soon.php";
                    ...
                    <div class="row">
                        <div class="sidebar col-md-3">
                            <div class="post-padding clearfix">
                                <ul class="nav nav-pills nav-stacked">
									...
									<li class="active"><a href="ending-soon.php"><span class="glyphicon glyphicon-off"></span>  <?php echo $lang[117]; ?></a></li>
                        ...
                        <div class="content col-md-9">
                            <div class="post-padding">
                                <div class="job-title nocover hidden-sm hidden-xs"><h5><?php echo $lang[117]; ?></h5></div>
                                        ...
                                        <div class="col-md-12 col-sm-12">   
                                            ...
                                            <div class="table-responsive">
												<table width="100%" class="table table-striped table-bordered table-hover">
													<thead>
														<tr>
															<td colspan="7" align="left" valign="top"><h1><?php echo $lang[171]; ?></h1></td>
														</tr>
														<tr>
															<th width="24%" align="left"><?php echo $lang[18]; ?></th>
															<th width="10%" align="left"><?php echo $lang[19]; ?></th>
															<th width="8%" style="text-align:center"><?php echo $lang[20]; ?></th>
													...
													<tbody>
														...
														<tr id="main_tr<?php echo $row->prj_id; ?>" onMouseOver="show_desc(<?php echo $row->prj_id; ?>)" onMouseOut="hide_desc(<?php echo $row->prj_id; ?>)">
															...
															<td width="8%" valign="top" style="text-align:center">
															<?php

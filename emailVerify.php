...
$usr_id=$_GET['u'];
$sql="select * from user where md5(usr_id)='".$usr_id."' and usr_status='1'";
$res=mysql_query($sql);
...
<?php	if(mysql_num_rows($res)>0)
		{	
	        ...
	        if($row->usr_emailVerified == '0')
			{	?>
	        <?php
				$upd_sql="update user set usr_emailVerified='1' where usr_id='".$row->usr_id."'";
				mysql_query($upd_sql);
            ...
            <script type="text/javascript">
			    ...
			    <div><h2 class="header-txt1-style align-center-txt"><?php echo $lang[304]; ?></h2></div>
	<?php	}
			else
			{	?>
				<div><h2 class="header-txt1-style align-center-txt"><?php echo $lang[305]; ?></h2></div>
     <?php	}	?>
<?php	}
		else
		{	?>
		<div><h2 class="header-txt1-style align-center-txt"><?php echo $lang[306]; ?></h2></div>				
<?php	}	?>
<!-- basic scripts -->

<div id="footer-area">
	<footer class="footer-wrapper clearfix" >
		...
		<section class="footer-wrapper-center-col">
			<div class="footer-wrapper-center-col-nav">
				<h6><?php echo $lang[76]; ?></h6>
				<ul>
		...
		<section class="footer-wrapper-right-col">
			<div class="clearfix">
				<ul class="lft-col">
					...
					<li><a href="#"><img src="images/twitter-icon.png" alt="" /><?php echo $lang[91]; ?></a></li>
				</ul>
				<ul class="rgt-col">
					<li><a href="#"><img src="images/rss-icon.png" alt="" /><?php echo $lang[92]; ?></a></li>

...
<style>
div.modal-dialog-head {	background-color: #EFEFEF; 	padding: 10px 20px; 	-moz-border-radius: 4px 4px 0 0; 	-webkit-border-radius: 4px 4px 0 0; }
div.modal-dialog-body {	padding: 20px; }
#all-data-list {	border: 1px solid #CCCCCC; 	height: 370px; 	overflow-x: hidden; 	overflow-y: auto; }
#all-data-list li {	padding: 3px 10px; 	font-size: 14px; 	cursor: pointer; }
#all-data-list li.active {	background-color: #C6E8F5; }
li.active .icon-skill-chosen {	display: block; }
.icon-skill-chosen {
	display: none; 
	background-image: url('//cdn3.f-cdn.com/img/icons/icon_check.png?v=c9f8cedbddf533af820e0414bc4943d6');
	height:20px; 
	width: 20px; 
	float: right; 
}
#all-data-list li.mouse-over {	background-color: #C6E8F5; }
...
#btn-modal-dialog-close {	position: absolute; 	top: 7px; 	right: 7px;	width: 18px;	height: 18px; 	cursor: pointer; }
</style>
...
<!-- Google Code for User Remarketing List -->
<img src="images/a.gif" width="1" border="0" height="1">

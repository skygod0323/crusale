...
/**** code for email verification start here ****/
		...
		<div style="width:650px;height:100px; padding-bottom:0;">'.$lang[301].'<br/>
		<a href="http://'.$_SERVER['HTTP_HOST'].'/emailVerify.php?u='.md5($row->usr_id).'" target="_blank">http://'.$_SERVER['HTTP_HOST'].'/emailVerify.php?u='.md5($row->usr_id).'</a>
		</div></div>';*/
	...
	//	validate::send_mail($to, $row->usr_email, $row->usr_name, $row->usr_email, $cc, getWebSiteName(), $comment);
...
<div><h2 class="header-txt1-style align-center-txt"><?php echo $lang[303]; ?></h2></div>
<div class="row">
		<div class="col-xs-12">
<?php  /*echo get_page_content(1);*/   ?>
</div>
</div>

                ...
                <repeater>
                    ...
                    <layout label="Text only">
                        <table class="" border="0" cellpadding="0" cellspacing="0" width="580">
                            <tbody><tr>
                                <td class="" width="580">
                                   <p style="font-size: 14px; line-height:24px; margin-top:0px; margin-bottom:18px; font-family: HelveticaNeue, sans-serif;" align="left"><singleline label="Title">'.$lang[778].''.$row_to_usr->usr_name.',<br/><br/>'.$row_from_usr->usr_name.''.$lang[779].'('.$lang[777].' '.$row->inv_id.').<br/><br/>'.getWebSiteName().'</singleline></p>
								   <p></p>

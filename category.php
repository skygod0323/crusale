...
if($_SESSION['uid']==''){
$al->setsql("select * from project, project_budget, user where prj_id=pb_prj_id and prj_usr_id=usr_id and prj_id in(select distinct ps_prj_id from project_skill where ps_sk_id='".$sk_id."') and prj_status='open' and prj_id not in(select ppo_prj_id from project_promotion_option where ppo_status='1' and ppo_pp_id=(select pp_id from project_promotion where pp_name='private' and pp_status='1'))");
}
else
{
$al->setsql("select * from project, project_budget, user where prj_id=pb_prj_id and prj_usr_id=usr_id and prj_id in(select distinct ps_prj_id from project_skill where ps_sk_id='".$sk_id."') and prj_status='open'");
}
                                ...
                                <div class="job-title nocover hidden-sm hidden-xs"><h5><?php echo $row_sk->sk_name; ?> <?php echo $lang[275]; ?></h5></div>
                                    ...
                                    <div class="row">
                                        <div class="col-md-12 col-sm-12">   
                                            <div class="col-md-12 col-sm-12"> 
												<form method="get" action="search-jobs.php" class="form-horizontal" onSubmit="return validSearch();">
													<div class="row">
													<div class="col-md-2 col-sm-4">
													<label class="control-label"><?php echo $lang[276]; ?> </label>
													</div>
													<div class="col-md-8 col-sm-8">
													<input name="keyword" id="keyword" type="text" class="form-control"/>
													
													<p style="margin:10px 0 10px 0;font-size:12px;"><?php echo $lang[277]; ?></p>
													</div>
													<div class="col-md-2 col-sm-8" style="text-align:left;">
													<button type="submit" id="btnSave" name="" class="btn btn-sm btn-info form-control"><i class="icon-search nav-search-icon"></i><?php echo $lang[278]; ?></button>
													</div>		 
													</div>
												...
												<div class="table-responsive">
													<table width="100%" class="table table-striped table-bordered table-hover">
														...
														?>
															...
															<tr>
																<td colspan="7">
																	<div class="admin-dtls" style="text-align:center; color:red; border-bottom:1px solid #ccc; padding-bottom:5px; font-weight:bold; font-size:14px;"><?php echo $lang[279]; ?></div>
																</td>
															</tr>
															<?php } ?>  
															<tr>
																<td colspan="7" align="left" valign="top" class="recent-project-box-footer"><?php echo $showitems; ?></td>
															</tr>
															<tr>
																<td colspan="7" align="right" valign="top" class="recent-project-box-footer">
